...
def main():
    ...
    args.model = "deepspeech-0.9.3-models.pbmm"
    # args.scorer = "deepspeech-0.9.3-models.scorer"
    args.audio = r"generated.wav"
    args.extended = True
    ...
    if args.extended:
        data = metadata_to_string(ds.sttWithMetadata(audio, 1).transcripts[0])
        print(data)
        with open('out.txt', 'w') as f:
            f.write(data)
    elif args.json:
        data = metadata_json_output(ds.sttWithMetadata(audio, args.candidate_transcripts))
        print(data)
